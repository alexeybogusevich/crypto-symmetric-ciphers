namespace KNU.Crypto.SymmetricCiphers.Kalyna.Data
{
    public static class Tables
    {
        public static byte[][,] SBoxes = new byte[4][,] {
            new byte[16, 16] {
        ...
        public static byte[][,] InvSBoxes = new byte[4][,] {
            new byte[16, 16] {
        ...
        public static byte[,] MDS = new byte[8, 8]{
        ...
        public static byte[,] InvMDS = new byte[8, 8]{
